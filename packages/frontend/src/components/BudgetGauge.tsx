    ...
    <article className="panel-card p-5">
      ...
      <div className="mt-5">
        <div className="mb-2 flex items-center justify-between text-[10px]">
          <span className="text-slate-500">每日使用率</span>
        ...
        <div className="mt-3 flex items-center justify-between">
          <span className="flex items-center gap-1.5 text-[10px] text-emerald"><TrendingDown size={12} />$99.95 可用</span>
          <span className="font-mono text-[10px] text-slate-500">$100.00 每日上限</span>
        </div>
      </div>
    </article>
  );
