...
export function Header({ balance, defending, mode, connection, liveConfigured, onModeChange }: HeaderProps) {
  ...
  return <header className="main-header border-b border-line/80 bg-cyber/85 backdrop-blur-xl">
    <div className="main-header__inner mx-auto flex max-w-[1680px] flex-wrap items-center justify-between gap-4 px-5 py-4 lg:px-8">
      ...
      <div className="main-header__metrics flex flex-wrap items-center justify-end gap-2.5 sm:gap-3">
